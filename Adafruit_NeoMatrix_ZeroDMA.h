...
class Adafruit_NeoMatrix_ZeroDMA : public Adafruit_GFX, public Adafruit_NeoPixel_ZeroDMA {
 ...
 public:
  ...
  Adafruit_NeoMatrix_ZeroDMA(uint8_t matrixW, uint8_t matrixH, uint8_t tX,
    uint8_t tY, uint8_t pin = 5,
    uint8_t matrixType = NEO_MATRIX_TOP + NEO_MATRIX_LEFT + NEO_MATRIX_ROWS +
